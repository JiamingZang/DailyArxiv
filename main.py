...
keywords = ["6d Object Pose Estimation","Human Pose Estimation","3d Gaussian Splatting","diffusion"] # TODO add more keywords
...
f_is.write("---\n")
f_is.write("**Please check the [Github](https://github.com/JiamingZang/DailyArxiv) page for a better reading experience and more papers.**\n\n")
